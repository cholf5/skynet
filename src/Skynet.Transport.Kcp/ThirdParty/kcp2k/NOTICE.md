...
Skynet exposes them through its own wrapper interfaces (`KcpSession` / `KcpConnection`) so the
backing implementation can be replaced later without leaking kcp2k APIs.
